...
public class TotalLeadAdapter extends ArrayAdapter<String> {
   ...
   public static String user;
    public TotalLeadAdapter(Context context, ArrayList<String> firstname, ArrayList<String> lastName, ArrayList<String> totalcount, ArrayList<String> completecount, ArrayList<String> pendingcount, ArrayList<String> usenamee,ArrayList<String> uuuserid) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
      ...
      //  useridddd=(TextView)rowView.findViewById(R.id.userid) ;
       // Constants.user=userid
        // .get(position);
       // Constants.Userid="100";
       ...
       // useridddd.setText(uuuserid.get(position));
       // userid.setVisibility(View.GONE);
      //  user=useridddd.getText().toString();
