...
import com.mitosis.fieldtracking.regionalmanager.RMConstants;
...
public class ChangepasswordDeeplink extends AppCompatActivity {
...
//                        jsonObject.put("userName", sUsername);
                        ...
                        new MyAsyncTask(ChangepasswordDeeplink.this).execute();
    ...
    class MyAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            registerUserURL = RMConstants.forgot;
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("Password has reset successfully.\n")) {
                ...
                Intent main = new Intent(ChangepasswordDeeplink.this,LoginActivity.class);
                startActivity(main);
