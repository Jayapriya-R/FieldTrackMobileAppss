...
public class RMMainActivity extends AppCompatActivity implements  NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rmactivity_main);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_1:
                fragmentClass = RMTabFragment.class;
                args.putString(RMConstants.FRAG_A, "totallead");
                break;
            case R.id.nav_3:
                fragmentClass = RMNotificationss.class;
                args.putString(RMConstants.FRAG_B, "detail");
                break;
            case R.id.nav_4:
                fragmentClass = RMProfileFragment.class;
                //args.putString(RMConstants.FRAG_c, "rmprofile");
                break;
            case R.id.Signout:
    ...
    public void homeFragment() {
        try {
            Bundle args = new Bundle();
            Class fragmentClass = RMTabFragment.class;
            args.putString(RMConstants.FRAG_A, "totallead");
