...
public class RMCompleteAdapter extends ArrayAdapter<String> {
    ...
    public RMCompleteAdapter(Context context, ArrayList<String> pcontactName, ArrayList<String> status, ArrayList<String> leadname,
        ...
        super(context, R.layout.rmcompetedtab, pcontactName);
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        final View rowView = inflater.inflate(R.layout.rmcompetedtab, parent, false);
