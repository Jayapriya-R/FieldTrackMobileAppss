...
public class RMForgotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rmforgotpass);
        context = this;
            ...
            public void onClick(View v) {
                ...
                if (!sUsername.isEmpty()||!sNewpass.isEmpty()||!sConfirmpass.isEmpty()){
                    ...
                    try {
                        ...
                        new MyAsyncTask(RMForgotActivity.this).execute();
    ...
    class MyAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("Password has reset successfully.\n")) {
                ...
                Intent main = new Intent(RMForgotActivity.this,RMLoginPageActivity.class);
                startActivity(main);
