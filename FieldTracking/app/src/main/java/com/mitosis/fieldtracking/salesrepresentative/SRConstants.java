...
public class SRConstants {
    public final static String FRAG_A="srfragment_a";
    public final static String FRAG_B="fragment_b";
    public final static String FRAG_D="srmaps";
    public final static String FRAG_F="srprofile";
    ...
    public static String listUrl="http://202.61.120.46:9081/FieldTracking/lead/list?userId=";
    ...
    public static String pending="http://202.61.120.46:9081/FieldTracking/leadTracking/getAllLeadList?repId=";
