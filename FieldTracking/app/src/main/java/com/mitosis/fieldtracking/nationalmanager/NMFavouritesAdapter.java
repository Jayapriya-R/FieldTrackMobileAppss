...
public class NMFavouritesAdapter extends ArrayAdapter<String> {
    ...
    public NMFavouritesAdapter(Context context, ArrayList<String> firstname, ArrayList<String> lastname, ArrayList<String> role) {
        super(context, R.layout.nmemployee, firstname);
        this.getContext();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View rowView = inflater.inflate(R.layout.nmemployee, parent, false);
