...
public class SRForgotFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.srforgot);
        context=this;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.srmain, menu);
        SRForgotFragment.this.setTitle("FORGOT PASSWORD");
        return true;
    }
}